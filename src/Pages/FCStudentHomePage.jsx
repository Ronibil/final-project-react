...
export default function StudentHomePage() {
  ...
  const FutureClasses = () => {
    let classList = futreClasses.map((classInList) => <FCClassCard classToCard={classInList} type="studentFutre" />);
    return classList;
  };
      ...
      <Card xs={12} style={{ width: '30rem' }}>
        <Card.Body align="center">
          ...
          {futreClasses.length == 0 ? (
            ...
            <>
              <Card.Text>
                שיעוריים עתידיים שלי
              </Card.Text>
              {futreClasses.map((c) => (
                <FCClassCard classToCard={c} type="studentFutre" ShowModaAreYouSure={ShowModaAreYouSure} />
              ))}
              <br />
            </>
          )}
